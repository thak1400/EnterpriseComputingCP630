...
public class use_knn_model {
	...
	public static void main(String[] args) throws Exception {
		...
		Instances unlabeled = new Instances(new BufferedReader(new FileReader(DATA_PATH + "car_unlabeled.arff")));
		...
		// deserialize model
		Classifier cls1 = (Classifier) weka.core.SerializationHelper.read(MODEL_PATH + "car_knn.bin");
		...
		// in file car_test.arff
		BufferedWriter writer = new BufferedWriter(new FileWriter(DATA_PATH + "car_labeled.arff"));
